/*To Accept & Display Number of employee details whose salary>5000 using Array of structure(Call by Value)*/
#include<stdio.h>
struct employee
...
void main()
{
	...
	int i;
	float n;
	void displayemp(struct employee x[],int n);	//Function Declaration
	clrscr();
...
void displayemp(struct employee x[],int n)	//Function Definition
{
	int i;
